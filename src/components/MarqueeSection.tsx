        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4">
                ...
                <div className="grid gap-5 lg:grid-cols-[320px_1fr]">
                    ...
                    <div className="card hidden rounded-3xl p-2 shadow-sm lg:block">
                            ...
                            <div className="space-y-0.5 p-2">
                                {merged.map((f, i) => (
                                    ...
                                    >
                                        {/* Logo */}
                                        <div
                                            className={`relative flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-slate-100 transition-all duration-200 ${
                                                selected.id === f.id
                                                    ? "border-amber-300"
                                                    : "border-slate-200"
                                            }`}
                    ...
                    <div className="flex min-w-0 flex-col gap-5">
                                ...
                                {merged.map((f) => (
                                    <button
                                        ...
                                        className={`relative h-18 w-18 shrink-0 snap-center rounded-[1.5rem] border-2 transition-all duration-300 ${
                                            selected.id === f.id
                                                ? "scale-110 border-amber-500 bg-amber-50 shadow-xl ring-8 shadow-amber-200/40 ring-amber-500/10"
                        ...
                        <div className="card relative min-h-[380px] overflow-hidden rounded-[2.5rem] shadow-md sm:rounded-3xl">
                            {/* Top accent stripe */}
                            <div className="absolute top-0 right-0 left-0 h-1.5 bg-gradient-to-r from-amber-400 via-amber-500 to-green-500" />
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-start">
                                        <div className="relative flex h-18 h-[72px] w-18 w-[72px] shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 shadow-sm">
                                            {selected.logo &&
                                            !selected.logo.startsWith("bg-") ? (
                                                <Image
                                                    src={selected.logo}
                                                    alt={selected.short}
                                                    fill
