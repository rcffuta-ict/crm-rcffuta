    ...
    return (
        <footer className="relative overflow-hidden border-t border-slate-200 bg-[#f4f4f0] pt-20 pb-10 text-slate-500">
            ...
            <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="mb-6 flex items-center gap-2">
                        {hierarchy.map((h, i) => (
                            ...
                            >
                                ...
                                <span
                                    className={`text-[10px] font-bold tracking-widest uppercase ${i === hierarchy.length - 1 ? "text-amber-600" : "text-slate-400"}`}
                                >
                                    {h.name}
                                </span>
                            </span>
                ...
                {/* ── Navigation ── */}
                <div>
                    <h4 className="mb-6 text-xs font-bold tracking-widest text-slate-900 uppercase">
                        Explore
                    </h4>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <div>
                                <span className="block font-semibold text-slate-900">
                                    {footer.contact.addressTitle}
                                </span>
                                <span className="mt-1 block text-xs text-slate-500">
                                    {footer.contact.addressDesc}
                                </span>
                                <a
